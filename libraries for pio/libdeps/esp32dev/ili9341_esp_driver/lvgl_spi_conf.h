...
#endif
#define DISP_SPI_CLK CLK_PIN
#if defined (CONFIG_LV_DISPLAY_USE_SPI_CS)
    #define DISP_SPI_CS LCD_CS_PIN
#else
...
#else
    #define TP_SPI_MOSI TOUCH_MOSI_PIN
    #define TP_SPI_MISO TOUCH_MISO_PIN
    #define TP_SPI_CLK  TOUCH_CLK_PIN
    #define TP_SPI_CS   TOUCH_CS_PIN
#endif
#endif
