...
"            if (response.ok) {\n"
"              window.location.href = \"http://_IP/dashboard\";\n"
"            } else {\n"
...
"      const url = `http://_IP/${setting}`;\n"
"      const login_redirect = `http://_IP/login`;\n"
"\n"
"      if (setting === \"device\") {\n"
"        const formHtml = `\n"
...
"  </div>\n"
"  <div style=\"display: flex; flex-direction: column; align-items: center; margin-bottom: 10px;\">\n"
"    <label for=\"server_address\" style=\"margin-right: 10px;\">Server Address:</label>\n"
"    <input type=\"text\" id=\"server_address\" name=\"server_address\" required style=\"padding: 8px; border: none; border-bottom: 2px solid #ddd; width: 100%; margin-bottom: 10px; text-align: center\">\n"
"  </div>\n"
"  <div style=\"display: flex; flex-direction: column; align-items: center; margin-bottom: 10px;\">\n"
...
"          window.location.href = 'http://_IP/enrollment';\n"
"        } "
"\n"
"      else {\n"
"        fetch(url)\n"
...
"      const server_addr = document.getElementById('server_address').value;\n"
"      const l_id = document.getElementById('location_id').value;\n"
"\n"
"\n"
"      const url = 'http://_IP/getDeviceConfigs';\n"
"\n"
"      fetch(url, {\n"
"        method: 'POST',\n"
"        body: JSON.stringify({\n"
...
"          $.getJSON('http://_IP/getStdData', function(data) {\n"
...
"              $('<td>').text(student.finger_count).appendTo(row);\n"
