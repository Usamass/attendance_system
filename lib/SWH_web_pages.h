...
"        fetch(\"http://192.168.50.128/getData\", {\n"
"          method: \"POST\",\n"
"          headers: {\n"
...
"            if (response.ok) {\n"
"              window.location.href = \"http://192.168.50.128/dashboard\";\n"
"            } else {\n"
...
"      const url = `http://192.168.50.128/${setting}`;\n"
"      const login_redirect = `http://192.168.50.128/login`;\n"
"\n"
"      if (setting === \"device\") {\n"
"        const formHtml = `\n"
...
"        fetch(\"http://192.168.50.128/logout\", {\n"
"          method: \"GET\",\n"
"          headers: {\n"
"            \"Content-Type\": \"application/json\",\n"
"          }\n"
...
"          window.location.href = 'http://192.168.50.128/enrollment';\n"
"        } "
"\n"
"      else {\n"
"        fetch(url)\n"
...
"      const url = 'http://192.168.50.128/dateTime';\n"
"\n"
"      fetch(url, {\n"
"        method: 'POST',\n"
...
"\n"
"\n"
"      const url = 'http://192.168.50.128/getDeviceConfigs';\n"
"\n"
"      fetch(url, {\n"
"        method: 'POST',\n"
"        body: JSON.stringify({\n"
...
"    fetch('http://192.168.50.128/network')\n"
...
"          $.getJSON('http://192.168.50.128/getStdData', function(data) {\n"
...
"          $.ajax({\n"
"            url: 'http://192.168.50.128/enrollStudent',\n"
"            method: 'POST',\n"
