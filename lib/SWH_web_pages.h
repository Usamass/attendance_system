...
"      const url = `http://192.168.50.140/${setting}`;\n"
"      const login_redirect = `http://192.168.50.140/login`;\n"
"\n"
"      if (setting === \"device\") {\n"
"        const formHtml = `\n"
...
"        fetch(\"http://192.168.50.140/logout\", {\n"
"          method: \"GET\",\n"
"          headers: {\n"
"            \"Content-Type\": \"application/json\",\n"
"          }\n"
...
"      const url = 'http://192.168.50.140/dateTime';\n"
"\n"
"      fetch(url, {\n"
"        method: 'POST',\n"
...
"\n"
"\n"
"      const url = 'http://192.168.50.140/getDeviceConfigs';\n"
"\n"
"      fetch(url, {\n"
"        method: 'POST',\n"
"        body: JSON.stringify({\n"
...
"    fetch('http://192.168.50.140/network')\n"
...
"          $.getJSON('http://192.168.50.140/getStdData', function(data) {\n"
...
"              $('<td>').text(student.vu_id).appendTo(row);\n"
