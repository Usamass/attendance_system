...
{
    uint8_t buffer_id_int = 0;
    uint16_t result = 0;
    buffer_id_int = (uint8_t) strtol(buffer_id, NULL, 10);

    char tx_cmd_data[13] = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00, 0x04, 0x02};
    char check_sum_data[2] = {0x00, 0x00};
    uint8_t confirmation_code = 0;
    tx_cmd_data[10] = buffer_id_int;
//  calculating check sum
    ...
    uint16_t checksum_value = result;
    check_sum_data[0] = (checksum_value >> 8) & (0xFF);
    check_sum_data[1] = checksum_value & (0xFF);
    ...
    printf("%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x" , tx_cmd_data[0],tx_cmd_data[1],
    tx_cmd_data[2],tx_cmd_data[3],tx_cmd_data[4],tx_cmd_data[5],tx_cmd_data[6],tx_cmd_data[7],
    tx_cmd_data[8],tx_cmd_data[9],tx_cmd_data[10],tx_cmd_data[11],tx_cmd_data[12]);
...
{
    uint8_t buffer_id_int = 0;
    uint16_t page_id_int = 0;
    uint16_t result = 0;
    buffer_id_int = (uint8_t) strtol(buffer_id, NULL, 10);
    page_id_int = (uint16_t) strtol(page_id, NULL, 10);
    ...
    tx_cmd_data[10] = buffer_id_int;
    tx_cmd_data[11] = (page_id_int >> 8) & (0xFF);
    tx_cmd_data[12] = page_id_int & (0xFF);
//  calculating check sum
    ...
    printf("%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x" , 
    tx_cmd_data[0],tx_cmd_data[1],tx_cmd_data[2],tx_cmd_data[3],
    tx_cmd_data[4],tx_cmd_data[5],tx_cmd_data[6],tx_cmd_data[7],
    tx_cmd_data[8],tx_cmd_data[9],tx_cmd_data[10],tx_cmd_data[11],
    tx_cmd_data[12],tx_cmd_data[13],tx_cmd_data[14]);
...
{
    uint8_t buffer_id_int = 0;
    uint16_t start_page_int = 0;
    uint16_t page_number_int = 0;
    uint16_t result = 0;
    uint8_t confirmation_code = 0;

    buffer_id_int = (uint8_t) strtol(buffer_id, NULL, 10);
    start_page_int = (uint16_t) strtol(start_page, NULL, 10);
    page_number_int = (uint16_t) strtol(page_number, NULL, 10);
    ...
    tx_cmd_data[10] = buffer_id_int;
    tx_cmd_data[11] = (start_page_int >> 8) & (0xFF);
    tx_cmd_data[12] = start_page_int & (0xFF);
    tx_cmd_data[13] = (page_number_int >> 8) & (0xFF);
    tx_cmd_data[14] = page_number_int & (0xFF);
    ...
    printf("%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x,%0x" , 
    tx_cmd_data[0],tx_cmd_data[1],tx_cmd_data[2],tx_cmd_data[3],
    tx_cmd_data[4],tx_cmd_data[5],tx_cmd_data[6],tx_cmd_data[7],
    tx_cmd_data[8],tx_cmd_data[9],tx_cmd_data[10],tx_cmd_data[11],
    tx_cmd_data[12],tx_cmd_data[13],tx_cmd_data[14],tx_cmd_data[15],tx_cmd_data[16]);
